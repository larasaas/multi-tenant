...
//        ];
        $user=[
            'id'=>$jwt_data->id,
            'tenant_id'=>$jwt_data->data->t_i,
            'tenant_type'=>$jwt_data->data->t_t,
            'name'=>$jwt_data->data->na,
            'account'=>$jwt_data->data->ac,
            'account_type'=>$jwt_data->data->ac_t,
            'is_admin'=>$jwt_data->data->is_a,
        ];
//        print_r($user);die();
//        return $user;
